...
class TicksStreamResponseModel extends Equatable {
  const TicksStreamResponseModel({
  ...
  factory TicksStreamResponseModel.fromJson(Map<String, dynamic> json) {
    return TicksStreamResponseModel(
      echoReq:
