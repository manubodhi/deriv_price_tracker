...
class ActiveSymbolsResponseModel {
  ...
  factory ActiveSymbolsResponseModel.fromJson(Map<String, dynamic> json) {
    return ActiveSymbolsResponseModel(
      activeSymbols: json["active_symbols"] == null
          ? []
          : List<ActiveSymbols>.from(
              json["active_symbols"]!.map((x) => ActiveSymbols.fromJson(x))),
      echoReq:
  ...
  Map<String, dynamic> toJson() => {
        "active_symbols":
            List<ActiveSymbols>.from(activeSymbols.map((x) => x.toJson())),
